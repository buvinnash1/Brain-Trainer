...
public class multiplicationscreen extends AppCompatActivity {
    TextView result;
    TextView points;
    Button button1;
    Button button2;
    ...
    public void playagain1(final View view) {
        ...
        final MediaPlayer waterprooftapebeats = MediaPlayer.create(this, R.raw.codedaybeat4);
        waterprooftapebeats.start();

        exitbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(multiplicationscreen.this, splashscreen.class));
