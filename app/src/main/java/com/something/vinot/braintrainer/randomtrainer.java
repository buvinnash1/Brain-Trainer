...
public class randomtrainer extends AppCompatActivity {
    TextView result;
    TextView points;
    Button button1;
    Button button2;
    ...
    public void playagain1(final View view) {
        ...
        final MediaPlayer waterprooftapebeats = MediaPlayer.create(this, R.raw.codedaybeat2);
        waterprooftapebeats.start();

        exitbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(randomtrainer.this, splashscreen.class));
    ...
    public void generatequestion() {
        ...
        //Randomquestion
            ...
            int choosequestiontype = rand.nextInt(3);

        if (choosequestiontype == 0) {

            choosequestiontype = rand.nextInt(3);
        ...
        if (choosequestiontype == 2) {

            choosequestiontype = rand.nextInt(3);

            question.setText(Integer.toString(num1) + "x" + Integer.toString(num2));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_randomtrainer);
